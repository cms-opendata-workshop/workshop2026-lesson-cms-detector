...
- **the same event can arrive in two different datasets** (this is special important if working with many datasets as event duplication can happen and one has to account for it)
